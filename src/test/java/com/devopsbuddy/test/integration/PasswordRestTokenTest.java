...
public class PasswordRestTokenTest extends AbstractIntegrationTest {

    private  int expirationTimeInMinutes = 120;
    ...
    public void testTokenExpirationLength() throws Exception {
        ...
        User user = createUser(testName.getMethodName(), testName.getMethodName()+"@sample.com");
